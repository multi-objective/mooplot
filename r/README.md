...
<!-- badges: start -->
[![CRAN Status](https://www.r-pkg.org/badges/version-last-release/mooplot)](https://cran.r-project.org/package=mooplot) [![CRAN Downloads](https://cranlogs.r-pkg.org/badges/grand-total/mooplot)](https://CRAN.R-project.org/package=mooplot)
[![R build
...
[![Codecov test coverage](https://codecov.io/gh/multi-objective/mooplot/branch/master/graph/badge.svg)](https://app.codecov.io/gh/multi-objective/mooplot?branch=master)
<!-- badges: end -->

[ [**Homepage**](https://multi-objective.github.io/mooplot/) ]  [ [**GitHub**](https://github.com/multi-objective/mooplot) ]
